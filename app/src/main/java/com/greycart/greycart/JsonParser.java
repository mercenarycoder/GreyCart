...
//OutputStream out;
    ...
    public String saveCategory(String url,String staff_id,String name,String status,String pos,String image)
    {
        HttpURLConnection httpURLConnection = null;
        try
        {
    ...
    public String signingIn(String url,String name,String email,String password,String city_id,String id_state,
                             String category_id)
    {
        HttpURLConnection httpURLConnection = null;
        try
